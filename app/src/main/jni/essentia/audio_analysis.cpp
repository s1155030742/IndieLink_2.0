...
JNIEXPORT jint JNICALL Java_com_indielink_indielink_RootPage_audio_analysis(JNIEnv* env, jclass, jstring audioFilename,jstring outputFilename,jstring profileFilename) {
